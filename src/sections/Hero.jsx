        ...
        >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="btn-modern gradient-purple-soft text-white shadow-glow-purple flex items-center gap-2 justify-center"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="btn-modern glass-strong text-white border-2 border-[#915EFF] hover:border-[#a575ff] flex items-center gap-2 justify-center"
            >
              <span className="relative z-10 font-bold">Resume (PDF)</span>
