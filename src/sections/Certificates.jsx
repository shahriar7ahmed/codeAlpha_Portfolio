    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        <Tilt
          ...
          scale={1.03}
          transitionSpeed={450}
          className='glass-card p-6 rounded-3xl sm:w-[360px] w-full min-h-[500px] flex flex-col shadow-modern-lg card-modern'
          style={{
              ...
              <div className='mt-auto flex flex-wrap gap-2'>
                {certificate.skills.slice(0, 4).map((skill) => (
                  <p
                    ...
                    className={`text-[12px] ${index % 4 === 0 ? "blue-text-gradient" :
